                                ...
                                <tbody>
                                    <?php foreach ($sensor as $ds => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $value['tinggi_i'] ?></td>
                                            <td class="text-center"><?= $value['tinggi_j'] ?></td>
                                            <td class="text-center"><?= $value['tinggi_k'] ?></td>
                                            <td class="text-center"><?= $value['tinggi_l'] ?></td>
