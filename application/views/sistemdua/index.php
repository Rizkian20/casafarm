                                ...
                                <tbody>
                                    <?php foreach ($sensor as $ds => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $value['tinggi_e'] ?></td>
                                            <td class="text-center"><?= $value['tinggi_f'] ?></td>
                                            <td class="text-center"><?= $value['tinggi_g'] ?></td>
                                            <td class="text-center"><?= $value['tinggi_h'] ?></td>
