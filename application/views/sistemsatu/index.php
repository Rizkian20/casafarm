                                ...
                                <tbody>
                                    <?php foreach ($sensor as $ds => $value) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $value['tinggi_a'] ?></td>
                                            <td class="text-center"><?= $value['tinggi_b'] ?></td>
                                            <td class="text-center"><?= $value['tinggi_c'] ?></td>
                                            <td class="text-center"><?= $value['tinggi_d'] ?></td>
